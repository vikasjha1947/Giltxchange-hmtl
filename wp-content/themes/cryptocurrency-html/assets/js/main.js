...
$( document ).ready(function() {
	...
	sync1.owlCarousel({
		...
		navText: ['<img src="wp-content/themes/cryptocurrency-html/assets/img/slider-arrow-left.svg">', '<img src="wp-content/themes/cryptocurrency-html/assets/img/slider-arrow-right.svg">'],
